// Original https://github.com/sraj/Swift-SRWebClient/blob/master/SRWebClient/SRWebClient.swift
//
//  SRWebClient.swift
//  SRWebClient
//
        ...
        var blockOperation:NSBlockOperation = NSBlockOperation({() -> Void in
            ...
            NSOperationQueue.mainQueue().addOperationWithBlock({() -> Void in
                if(response != nil && httpResponse!.statusCode >= 200 && httpResponse!.statusCode <= 300) {
                    //if(NSString(string: httpResponse!.allHeaderFields[NSObject(HeaderConstants.CONTENT_TYPE)]).containsString(MimeConstants.APPLICATION_JSON)) {
